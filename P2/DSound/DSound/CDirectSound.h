...
public: 
	...
	bool LockBuffer(LPDIRECTSOUNDBUFFER buf, DWORD offset, DWORD size, void** ptr1, DWORD* bytes1, void** ptr2, DWORD* bytes2); 
	bool UnlockBuffer(LPDIRECTSOUNDBUFFER buf, void* ptr1, DWORD bytes1, void* ptr2, DWORD bytes2); 
